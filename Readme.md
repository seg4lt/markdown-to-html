...
Markdown to HTML converter written in Zig. This is very opinionated and only supports a small subset of markdown syntax. This also has some magic features that I needed for my personal use case.
